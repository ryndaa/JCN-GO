...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Mar 2024 pada 01.40
...
CREATE TABLE `penginapan` (
  ...
  `harga_terendah` int(10) NOT NULL,
  `harga_tertinggi` int(10) NOT NULL,
  `jarak` float NOT NULL,
  `gambar` text DEFAULT NULL,
...
('PH202425', 'test', 'asdad', 2177218, 1000000000, 1000000000, 1, 'file_gambar/penginapan/gambar_penginapan_rimuru_nikki.jpg', 'oyo'),
...
('WST202425', 'Gembira Loka Zoo', 'Gembira Loka Zoo merupakan Kebun Raya dan Kebun Binatang yang berada di Kota Yogyakarta. Memiliki berbagai wahana rekreasi seperti interaksi satwa, kolam sentuh, kolam tangkap, terapi ikan, perahu kayuh, skuter air, ATV, bumper boat, speed boat, perahu katamaran, dll.', 'Jl. Kebun Raya No.2 Kota Gede Yogyakarta 55171', 60000, 75000, 1.9, 'file_gambar/wisata/gambar_wisata_gembira loka.jpeg'),
